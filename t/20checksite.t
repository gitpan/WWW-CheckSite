...
# $Id: 20checksite.t 673 2007-05-28 19:01:18Z abeltje $
...
{
    my $wcs = eval { WWW::CheckSite->new( ) };
    ok $@, "Dies without 'uri' attribute";
}
...

{
    ...
    ok $@, "Dies with empty 'uri' attribute";
}

{
    ...
    ok $@, "Dies without 'prefix' attribute";
}

{
    ...
    ok $@, "Dies with empty 'prefix' attribute";
}

{
    my $wcs = eval { WWW::CheckSite->load( {} ) };
    ok $@, "Dies without arguments";
}
...
SKIP: {
    eval qq{require Template};
    $@ and skip "HTML-Template already tested", 8;

    eval qq{require HTML::Template};
    $@ and skip "TT2 already tested.", 8;
